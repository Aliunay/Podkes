...
class NowPlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFF0E0D18), // Arka plan rengini
      appBar: AppBar(
        centerTitle: true,
        leading: IconButton(
          onPressed: () {
            Navigator.pop(context); // Geri gitmek için Navigator.pop kullanabilirsiniz
          },
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Image.asset(
                  'assets/images/muzik.png', // Dalga formu png buraya ekledik
                ),
              ),
            ),
